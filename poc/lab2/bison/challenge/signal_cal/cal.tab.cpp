...
static const char *const yytname[] =
{
  ...
  "MUL", "DIV", "L_PAR", "R_PAR", "ID", "EQUAL", "UMINUS", "';'",
...
{
     -10,    15,   -10,   -10,     0,     0,    -9,   -10,    -7,    25,
     -10,   -10,    30,     0,   -10,     0,     0,     0,     0,   -10,
     -10,    36,    10,    10,   -10,   -10
};
...
{
      11,    12,    13,     3,     0,     4,    14,     0,     5,    21,
      10,    22,    23,    24,    25,     2,    17,    18,     3,     0,
       4,     0,     0,     5,     0,     6,     0,     0,     7,    15,
      16,    17,    18,     0,    15,    16,    17,    18,    19,    20,
      15,    16,    17,    18
};

static const yytype_int8 yycheck[] =
{
       4,     5,    11,     3,    -1,     5,    13,    -1,     8,    13,
      10,    15,    16,    17,    18,     0,     6,     7,     3,    -1,
       5,    -1,    -1,     8,    -1,    10,    -1,    -1,    13,     4,
       5,     6,     7,    -1,     4,     5,     6,     7,    13,     9,
       4,     5,     6,     7
};
...
{
       0,    15,     0,     3,     5,     8,    10,    13,    16,    17,
      10,    17,    17,    11,    13,     4,     5,     6,     7,    13,
       9,    17,    17,    17,    17,    17
};
...
#line 45 "cal.ypp"
                       {printf("%f\n",yyvsp[-1]);}
#line 1112 "cal.tab.cpp"
    break;

  case 3: /* lines: lines stmt ';'  */
#line 46 "cal.ypp"
                         {printf("%f\n",yyvsp[-1]); }
#line 1118 "cal.tab.cpp"
    break;

  case 6: /* stmt: ID EQUAL expr  */
#line 52 "cal.ypp"
                     {yyval=IDListNum[int(yyvsp[-2])]=yyvsp[0]; }
#line 1124 "cal.tab.cpp"
    break;

  case 7: /* expr: expr ADD expr  */
#line 54 "cal.ypp"
                      {yyval=yyvsp[-2]+yyvsp[0];}
#line 1130 "cal.tab.cpp"
    break;

  case 8: /* expr: expr SUB expr  */
#line 55 "cal.ypp"
                      {yyval=yyvsp[-2]-yyvsp[0];}
#line 1136 "cal.tab.cpp"
    break;

  case 9: /* expr: expr MUL expr  */
#line 56 "cal.ypp"
                      {yyval=yyvsp[-2]*yyvsp[0];}
#line 1142 "cal.tab.cpp"
    break;

  case 10: /* expr: expr DIV expr  */
#line 57 "cal.ypp"
                      {yyval=yyvsp[-2]/yyvsp[0];}
#line 1148 "cal.tab.cpp"
    break;

  case 11: /* expr: L_PAR expr R_PAR  */
#line 58 "cal.ypp"
                         {yyval=yyvsp[-1];}
#line 1154 "cal.tab.cpp"
    break;

  case 12: /* expr: SUB expr  */
#line 59 "cal.ypp"
                              { yyval = -yyvsp[0]; }
#line 1160 "cal.tab.cpp"
    break;

  case 13: /* expr: NUMBER  */
#line 60 "cal.ypp"
               {yyval=yyvsp[0];}
#line 1166 "cal.tab.cpp"
    break;

  case 14: /* expr: ID  */
#line 61 "cal.ypp"
           {yyval = IDListNum[int(yyvsp[0])]; }
#line 1172 "cal.tab.cpp"
    break;


#line 1176 "cal.tab.cpp"
...
int yylex()
{
    ...
    while(1)
    {
        ...
        else if((t>='a'&&t<='z')||(t>='A'&&t<='Z')||(t=='_'))
        {
            ...
            //yylval=idStr;
            ungetc(t,stdin);
            //在容器中寻找值为idStr的元素，返回该元素的迭代器。否则，返回map.end()。
            //若不存在，则插入，且初值赋值为0
